...
### Request 12 nodes, each with 36 MPI tasks, and one thread
#PBS -l select=24:ncpus=36:mpiprocs=36:ompthreads=1
...
#JLS add ESMF shared library path to LD_LIBRARY_PATH
...
#JLS  C192) export DELTIM=900 ; export layout_x=12; export layout_y=16;  export NODES=96;
  C192) export DELTIM=900 ; export layout_x=8; export layout_y=9;  export NODES=24;
...
#JLS export mpiexec="mpiexec_mpt"
#JLS try MPI/OMP hybrid
export mpiexec="mpiexec_mpt omplace"
